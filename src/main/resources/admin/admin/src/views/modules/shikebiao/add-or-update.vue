<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="站点" prop="zhandian">
          <el-input v-model="ruleForm.zhandian" 
              placeholder="站点" clearable  :readonly="ro.zhandian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="站点" prop="zhandian">
              <el-input v-model="ruleForm.zhandian" 
                placeholder="站点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="首班车" prop="shoubanche">
          <el-input v-model="ruleForm.shoubanche" 
              placeholder="首班车" clearable  :readonly="ro.shoubanche"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="首班车" prop="shoubanche">
              <el-input v-model="ruleForm.shoubanche" 
                placeholder="首班车" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="末班车" prop="mobanche">
          <el-input v-model="ruleForm.mobanche" 
              placeholder="末班车" clearable  :readonly="ro.mobanche"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="末班车" prop="mobanche">
              <el-input v-model="ruleForm.mobanche" 
                placeholder="末班车" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="间隔时间" prop="jiangeshijian">
          <el-input v-model="ruleForm.jiangeshijian" 
              placeholder="间隔时间" clearable  :readonly="ro.jiangeshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="间隔时间" prop="jiangeshijian">
              <el-input v-model="ruleForm.jiangeshijian" 
                placeholder="间隔时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhandian'){
            this.ruleForm.zhandian = obj[o];
	    this.ro.zhandian = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='shoubanche'){
            this.ruleForm.shoubanche = obj[o];
	    this.ro.shoubanche = true;
            continue;
          }
          if(o=='mobanche'){
            this.ruleForm.mobanche = obj[o];
	    this.ro.mobanche = true;
            continue;
          }
          if(o=='jiangeshijian'){
            this.ruleForm.jiangeshijian = obj[o];
	    this.ro.jiangeshijian = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shikebiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shikebiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
