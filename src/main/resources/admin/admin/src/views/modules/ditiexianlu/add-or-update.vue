<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="起点" prop="qidian">
          <el-select :disabled="ro.qidian" v-model="ruleForm.qidian" placeholder="请选择起点">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="终点" prop="zhongdian">
          <el-select :disabled="ro.zhongdian" v-model="ruleForm.zhongdian" placeholder="请选择终点">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="途径路线" prop="tujingluxian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tujingluxian" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tujingluxian" label="途径路线" prop="tujingluxian">
                    <span v-html="ruleForm.tujingluxian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.piaojia = true;
          ...
          if(o=='tujingluxian'){
            this.ruleForm.tujingluxian = obj[o];
	    this.ro.tujingluxian = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.tujingluxian = this.ruleForm.tujingluxian.replace(reg,'../../../springboot1xl23/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ditiexianlu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ditiexianluCrossAddOrUpdateFlag = false;
						 this.parent.search();
